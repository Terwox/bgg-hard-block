...
for fixture in dom-filter consent-gate onboarding page-bridge page-bridge-security subscription-linking-disabled subscription-avatar-runtime ui-deferred-status content-runtime mixed-version-runtime lazy-content-runtime cache-hold content-mutation-performance content-reveal-failure bridge-trust-runtime bridge-retry-runtime bridge-retry-exhausted bridge-retry-terminal content-large-thread-performance spa-scope-teardown css-failsafe live-angular-quote; do
