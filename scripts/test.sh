...
for fixture in dom-filter consent-gate onboarding page-bridge settings-bridge subscription-linking-disabled content-runtime mixed-version-runtime lazy-content-runtime cache-hold; do
